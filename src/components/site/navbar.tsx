    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-navy font-display text-sm font-bold tracking-tight text-navy-foreground transition-transform duration-300 group-hover:scale-105">
              MDA
            </span>
        ...
        {open ? (
          <div className="border-t border-border bg-background/95 backdrop-blur-xl lg:hidden">
            <ul className="mx-auto max-w-6xl px-4 py-3 sm:px-6">
              ...
              <li className="mt-2 flex gap-2 px-3 pb-2 sm:hidden">
                {LANGS.map((l) => (
                  <button
                    key={l}
                    type="button"
